...
import { ArrowLeft, Save, Plus, Calendar, Dumbbell, X } from "lucide-react";
import { useTemplate } from "@/hooks/useTemplates";
import { useExercises } from "@/hooks/useExercises";
import { ExerciseExcelGrid } from "@/app/(dashboard)/coach/student/ExerciseExcelGrid";
import { updateTemplatePlan } from "@/app/(dashboard)/coach/student/actions";
...
export default function TemplateEditPage() {
  ...
  // Sincronizar el nombre cuando se carga la plantilla
  useEffect(() => {
    if (template?.name) {
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-zinc-500 ml-2">
              Plantilla • {template.sessions?.length || 0} sesiones
            </p>
          </div>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4">
            ...
            <div className="space-y-6">
              ...
              <button
                onClick={() => {
                  const maxWeek = template.sessions && template.sessions.length > 0
          ...
          {selectedSession ? (
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
              ...
              {selectedSession.session_exercises && selectedSession.session_exercises.length > 0 ? (
                <ExerciseExcelGrid exercises={selectedSession.session_exercises} role="COACH" />
              ) : (
